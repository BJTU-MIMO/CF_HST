...
SE_n_MF_Scalable_Power = zeros(K,M,Number,length(speed));
SE_n_LSFD_Scalable = zeros(K,M,Number,length(speed));
SE_n_LSFD_Scalable_Power = zeros(K,M,Number,length(speed));
...
for n = 1:Number %round(2*NumberOfSymbol/3);
    ...
    for sp = 1:length(speed)
        ...
        %     [SE_MF_Scalable_Power] = Compute_SE_MF_Scalable_Power(R,Q,hmean,I,ID,K,L,M,p,eta_min,sigma2,D);
        %     SE_n_MF_Scalable_Power(:,:,n,sp) = SE_MF_Scalable_Power(:,:);
        
        [SE_LSFD_Scalable_Power] = Compute_SE_LSFD_Scalable_Power(R,Q,hmean,I,ID,K,L,M,p,eta_min,sigma2,D);
        SE_n_LSFD_Scalable_Power(:,:,n,sp) = SE_LSFD_Scalable_Power(:,:);
...
% MF_Scalable_Power = squeeze(mean(mean(SE_n_MF_Scalable_Power(:,:,:,:),2),1));
% LSFD_Scalable_Power = squeeze(mean(mean(SE_n_LSFD_Scalable_Power(:,:,:,:),2),1));

MF_Scalable = squeeze(min(mean(SE_n_MF_Scalable(:,:,:,:),2)));
LSFD_Scalable = squeeze(min(mean(SE_n_LSFD_Scalable(:,:,:,:),2)));
MF_Scalable_Power = squeeze(min(mean(SE_n_MF_Scalable_Power(:,:,:,:),2)));
LSFD_Scalable_Power = squeeze(min(mean(SE_n_LSFD_Scalable_Power(:,:,:,:),2)));

% MF_Scalable = squeeze(max(mean(SE_n_MF_Scalable(:,:,:,:),2)));
% LSFD_Scalable = squeeze(max(mean(SE_n_LSFD_Scalable(:,:,:,:),2)));
% MF_Scalable_Power = squeeze(max(mean(SE_n_MF_Scalable_Power(:,:,:,:),2)));
% LSFD_Scalable_Power = squeeze(max(mean(SE_n_LSFD_Scalable_Power(:,:,:,:),2)));
...
% plot(sort(reshape(SE_n_LSFD_Scalable(:,:,:,t),[K*M*Number 1])),linspace(0,1,K*M*Number),'b-','LineWidth',2);
% plot(sort(reshape(SE_n_LSFD_Scalable_Power(:,:,:,t),[K*M*Number 1])),linspace(0,1,K*M*Number),'m-','LineWidth',2);

%plot(speed,squeeze(mean(MF_Scalable(ss,:),1)),'r-o','LineWidth',2);
plot(speed,squeeze(mean(LSFD_Scalable(ss,:),1)),'b-o','LineWidth',2);
%plot(speed,squeeze(mean(MF_Scalable_Power(ss,:),1)),'k--+','LineWidth',2);
plot(speed,squeeze(mean(LSFD_Scalable_Power(ss,:),1)),'b--+','LineWidth',2);

% plot(sort(MF_Scalable(ss,1)),linspace(0,1,Number_new),'r-','LineWidth',2);
% plot(sort(LSFD_Scalable(ss,1)),linspace(0,1,Number_new),'b-','LineWidth',2);
% plot(sort(LSFD_Scalable_Power(ss,1)),linspace(0,1,Number_new),'m-','LineWidth',2);
...
% hold on; box on;
%
% MF_Scalable1 = squeeze(mean(mean(mean(SE_n_MF_Scalable(:,:,:,:),2),3),4));
% LSFD_Scalable1 = squeeze(mean(mean(mean(SE_n_LSFD_Scalable(:,:,:,:),2),3),4));
% LSFD_Scalable_Power1 = squeeze(mean(mean(mean(SE_n_LSFD_Scalable_Power(:,:,:,:),2),3),4));
%
% plot(sort(MF_Scalable1(:)),linspace(0,1,K),'r-','LineWidth',2);
% plot(sort(LSFD_Scalable1(:)),linspace(0,1,K),'b-','LineWidth',2);
% plot(sort(LSFD_Scalable_Power1(:)),linspace(0,1,K),'m-','LineWidth',2);
